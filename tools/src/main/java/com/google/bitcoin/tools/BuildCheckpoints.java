...
public class BuildCheckpoints {
    public static void main(String[] args) throws Exception {
        ...
        final NetworkParameters params = BerycoinParams.get();
        ...
        final FileOutputStream fileOutputStream = new FileOutputStream("checkpointsberycoin", false);
        ...
        CheckpointManager manager = new CheckpointManager(params, new FileInputStream("checkpointsberycoin"));
